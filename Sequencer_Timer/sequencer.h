...
#define TIMER_INITIAL_VALUE_S       0
#define TIMER_INITIAL_VALUE_NS      NANOSECOND_PER_MILLISECOND * 10     // interval = 10ms;
#define TIMER_INTERVAL_S            0
#define TIMER_INTERVAL_NS           NANOSECOND_PER_MILLISECOND * 10     // interval = 10ms;
